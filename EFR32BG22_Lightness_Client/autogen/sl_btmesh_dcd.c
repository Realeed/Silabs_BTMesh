...
const uint8_t __mesh_dcd_page_1[] = {
  ...
  0x00, /* Number of Vendor Models = 0 */
    ...
    /* SIG Model 2: Generic OnOff Client (0x1001) */
    0x00, /* Corresponding_Present = 0, Format = 0 (short), Extended_Items_Count = 0 */

    /* SIG Model 3: Light Lightness Client (0x1302) */
    0x00, /* Corresponding_Present = 0, Format = 0 (short), Extended_Items_Count = 0 */
  ...
  0x00, /* Number of Vendor Models = 0 */
    ...
    /* SIG Model 0: Generic OnOff Client (0x1001) */
    0x00, /* Corresponding_Present = 0, Format = 0 (short), Extended_Items_Count = 0 */

    /* SIG Model 1: Light Lightness Client (0x1302) */
    0x00, /* Corresponding_Present = 0, Format = 0 (short), Extended_Items_Count = 0 */
};
